...
import 'package:vehicle_rental_app/features/vehicle/presentation/screens/vehicle_details_screen.dart';
...
class _VehicleListScreenState extends State<VehicleListScreen> {
  ...
  void initState() {
    super.initState();
    print('VehicleListScreen initState called');
    Future.microtask(() {
      print('Fetching vehicles in microtask');
  ...
  Widget build(BuildContext context) {
    print('VehicleListScreen build called');
    return Scaffold(
      appBar: AppBar(
      ...
      body: Consumer<VehicleProvider>(
        builder: (context, vehicleProvider, child) {
          print(
              'Consumer builder called - isLoading: ${vehicleProvider.isLoading}, error: ${vehicleProvider.error}, vehicles count: ${vehicleProvider.vehicles.length}');
